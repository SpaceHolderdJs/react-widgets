...
export const DEFAULT_PHONE_MODEL_URL = `https://unpkg.com/${__PKG_NAME__}@${__PKG_VERSION__}/assets/phone.glb`;
...
PhoneReveal.preload = (modelUrl: string = DEFAULT_PHONE_MODEL_URL) => {
